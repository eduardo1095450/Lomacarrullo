...
import { DsnProtocol, Event, Response, SentryRequest, SentryRequestType, Session, Transport, TransportOptions } from '@sentry/types';
...
export declare abstract class BaseTransport implements Transport {
    ...
    /** JSDoc */
    protected _send(sentryReq: SentryRequest, originalPayload?: Event | Session): Promise<Response>;
}
